...
public class Mayoclinic {
    ...
    public void before() throws Exception{
        ExtentSparkReporter exsprk = new ExtentSparkReporter("C:\\Users\\VICTUS\\Desktop\\ModelLab\\mayoclinic\\reports\\report1.html");
    ...
    public void test() throws IOException, InterruptedException
    {
        ...
        PropertyConfigurator.configure("C:\\Users\\VICTUS\\Desktop\\ModelLab\\mayoclinic\\src\\main\\java\\model\\lab\\resources\\log4j.properties");
        ...
        FileInputStream fs = new FileInputStream("C:\\Users\\VICTUS\\Desktop\\ModelLab\\mayoclinic\\mayoclinic.xlsx");
        ...
        driver.findElement(By.xpath("//*[@id=\"personalFirstName\"]")).sendKeys(one);
        driver.findElement(By.xpath("//*[@id=\"personalLastName\"]")).sendKeys(two);
        ...
        driver.findElement(By.xpath("//*[@id=\"personalAddress\"]")).sendKeys("Chettystreet");
        driver.findElement(By.xpath("//*[@id=\"personalCity\"]")).sendKeys("covai");
        driver.findElement(By.xpath("//*[@id=\"personalZip\"]")).sendKeys("641001");
        driver.findElement(By.xpath("//*[@id=\"personalPhone\"]")).sendKeys("0123546786");
        driver.findElement(By.xpath("//*[@id=\"personalEmail\"]")).sendKeys("disco@gmail.com");
    ...
    public void afterTest(ITestResult result) throws Exception{
        if(result.getStatus()==ITestResult.FAILURE)
        {
            ...
            String path = "C:\\Users\\VICTUS\\Desktop\\ModelLab\\mayoclinic\\reports"+result.getName()+"png";
